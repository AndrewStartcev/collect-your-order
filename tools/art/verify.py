"""Verify Batch 01 delivery dimensions, transparent margins and repeat seam."""
...
for entry in manifest:
    ...
    if 'floor-strip' not in entry['path']:
...
assert len(checks)==27,len(checks)
...
print('PASS: 27 PNGs, dimensions, RGBA, product margins, floor seam, 1600x900 preview')
